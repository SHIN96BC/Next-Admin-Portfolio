...
// type
import { DropzopType, FilePreviewProps } from '@Src/types/dropzone';
          ...
          return (
            <ListItem
              ...
              sx={{
                p: 0,
                m: 0.5,
                width: layoutType === DropzopType.standard ? 64 : layoutType === DropzopType.product ? 200 : 80,
                height: layoutType === DropzopType.standard ? 64 : layoutType === DropzopType.product ? 200 : 80,
                borderRadius: 1.25,
                position: 'relative',
                display: 'inline-flex',
