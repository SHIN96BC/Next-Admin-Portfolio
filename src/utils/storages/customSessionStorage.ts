...
const getEncryptedStr = (str: string, key: string): string => AES.encrypt(str, key).toString();
const getDecryptedStr = (str: string, key: string): string => AES.decrypt(str, key).toString(enc);
