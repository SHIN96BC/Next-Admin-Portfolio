...
// types
import { ThemeDirection, ThemeMode } from '@Src/types/config';
import Image from "next/image";

// image
import LoginBackgroundImage from '@Public/login_background.jpg';
  ...
  return (
    ...
    >
      <Box width="100vw" height="100vh">
        <Image fill src={LoginBackgroundImage} alt="background-image" />
      </Box>
